					...
					<div className={classes.right}>
						<div className={classes.techSkills}>
							...
							<p className={classes.text}>
								Css, HTML, JavaScript, React, Redux, Ruby, Ruby on Rails,
								POSTSQL, GIT, Github, APIs, Heroku, Vercel, Firebase, Figma
							</p>
						</div>
						<div className={classes.personalSkills}>
							<p className={classes.text}>
								Creative Spirit, Organized, Time Managemant, Motivated,
								Analytical Skiils,
							</p>
